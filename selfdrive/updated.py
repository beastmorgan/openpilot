...
DAYS_NO_CONNECTIVITY_MAX = 30000     # do not allow to engage after this many days
DAYS_NO_CONNECTIVITY_PROMPT = 29900  # send an offroad prompt after this many days
